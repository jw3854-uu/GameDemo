...
public class Trigger_ToggleGroup : TriggerNode
{
    ...
    public Trigger_ToggleGroup() : base() 
    {
        ...
        Port port_isAnyTogglesOn = CreatePortForNode(this, Direction.Output, typeof(System.Boolean), Port.Capacity.Single);
        port_isAnyTogglesOn.portName = "isAnyTogglesOn";
        outputContainer.Add(port_isAnyTogglesOn);

        Port port_isAllTogglesOff = CreatePortForNode(this, Direction.Output, typeof(System.Boolean), Port.Capacity.Single);
